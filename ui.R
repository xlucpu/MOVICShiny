...
UpdateTime="Last Updated: 11/24/2022"
                                                                                             ...
                                                                                             fixedRow(
                                                                                                 ...
                                                                                                 conditionalPanel(condition = "input.mRNA_getElites_survival==2",
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.mRNA_getElites_method==1",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.mRNA_getElites_filtration1==1",column(12,numericInput("mRNA_getElites_elite_num1",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.mRNA_getElites_method==2",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.mRNA_getElites_filtration2==1",column(12,numericInput("mRNA_getElites_elite_num2",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                             ...
                                                                                             fixedRow(
                                                                                                 ...
                                                                                                 conditionalPanel(condition = "input.lncRNA_getElites_survival==2",
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.lncRNA_getElites_method==1",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.lncRNA_getElites_filtration1==1",column(12,numericInput("lncRNA_getElites_elite_num1",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.lncRNA_getElites_method==2",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.lncRNA_getElites_filtration2==1",column(12,numericInput("lncRNA_getElites_elite_num2",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                             ...
                                                                                             fixedRow(
                                                                                                 ...
                                                                                                 conditionalPanel(condition = "input.DNA_methylation_getElites_survival==2",
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.DNA_methylation_getElites_method==1",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.DNA_methylation_getElites_filtration1==1",column(12,numericInput("DNA_methylation_getElites_elite_num1",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.DNA_methylation_getElites_method==2",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.DNA_methylation_getElites_filtration2==1",column(12,numericInput("DNA_methylation_getElites_elite_num2",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                             ...
                                                                                             fixedRow(
                                                                                                 ...
                                                                                                 conditionalPanel(condition = "input.copy_number_alterations_getElites_survival==2",
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.copy_number_alterations_getElites_method==1",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.copy_number_alterations_getElites_filtration1==1",column(12,numericInput("copy_number_alterations_getElites_elite_num1",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.copy_number_alterations_getElites_method==2",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.copy_number_alterations_getElites_filtration2==1",column(12,numericInput("copy_number_alterations_getElites_elite_num2",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                   ...
                                                                                   wellPanel(style="background-color:#47AEE9",
                                                                                             fixedRow(
                                                                                                 ...
                                                                                                 conditionalPanel(condition = "input.binary_somatic_mutation_getElites_survival==2",
                                                                                                                  column(12,radioButtons("binary_somatic_mutation_getElites_filtration", h5(strong("Choose a filtration method for binary somatic mutation dataset")), inline=TRUE, choices = c("elite.num"=1,"elite.pct"=2),selected=1)),
                                                                                             ...
                                                                                             fixedRow(
                                                                                                 ...
                                                                                                 conditionalPanel(condition = "input.radiomics_getElites_survival==2",
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.radiomics_getElites_method==1",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.radiomics_getElites_filtration1==1",column(12,numericInput("radiomics_getElites_elite_num1",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.radiomics_getElites_method==2",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.radiomics_getElites_filtration2==1",column(12,numericInput("radiomics_getElites_elite_num2",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                             ...
                                                                                             fixedRow(
                                                                                                 ...
                                                                                                 conditionalPanel(condition = "input.validation_mRNA_getElites_survival==2",
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.validation_mRNA_getElites_method==1",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.validation_mRNA_getElites_filtration1==1",column(12,numericInput("validation_mRNA_getElites_elite_num1",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.validation_mRNA_getElites_method==2",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.validation_mRNA_getElites_filtration2==1",column(12,numericInput("validation_mRNA_getElites_elite_num2",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                             ...
                                                                                             fixedRow(
                                                                                                 ...
                                                                                                 conditionalPanel(condition = "input.validation_lncRNA_getElites_survival==2",
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.validation_lncRNA_getElites_method==1",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.validation_lncRNA_getElites_filtration1==1",column(12,numericInput("validation_lncRNA_getElites_elite_num1",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.validation_lncRNA_getElites_method==2",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.validation_lncRNA_getElites_filtration2==1",column(12,numericInput("validation_lncRNA_getElites_elite_num2",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                             ...
                                                                                             fixedRow(
                                                                                                 ...
                                                                                                 conditionalPanel(condition = "input.validation_DNA_methylation_getElites_survival==2",
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.validation_DNA_methylation_getElites_method==1",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.validation_DNA_methylation_getElites_filtration1==1",column(12,numericInput("validation_DNA_methylation_getElites_elite_num1",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.validation_DNA_methylation_getElites_method==2",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.validation_DNA_methylation_getElites_filtration2==1",column(12,numericInput("validation_DNA_methylation_getElites_elite_num2",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                             ...
                                                                                             fixedRow(
                                                                                                 ...
                                                                                                 conditionalPanel(condition = "input.validation_copy_number_alterations_getElites_survival==2",
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.validation_copy_number_alterations_getElites_method==1",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.validation_copy_number_alterations_getElites_filtration1==1",column(12,numericInput("validation_copy_number_alterations_getElites_elite_num1",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.validation_copy_number_alterations_getElites_method==2",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.validation_copy_number_alterations_getElites_filtration2==1",column(12,numericInput("validation_copy_number_alterations_getElites_elite_num2",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                   ...
                                                                                   wellPanel(style="background-color:#47AEE9",
                                                                                             fixedRow(
                                                                                                 ...
                                                                                                 conditionalPanel(condition = "input.validation_binary_somatic_mutation_getElites_survival==2",
                                                                                                                  column(12,radioButtons("validation_binary_somatic_mutation_getElites_filtration", h5(strong("Choose a filtration method for binary somatic mutation dataset")), inline=TRUE, choices = c("elite.num"=1,"elite.pct"=2),selected=1)),
                                                                                             ...
                                                                                             fixedRow(
                                                                                                 ...
                                                                                                 conditionalPanel(condition = "input.validation_radiomics_getElites_survival==2",
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.validation_radiomics_getElites_method==1",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.validation_radiomics_getElites_filtration1==1",column(12,numericInput("validation_radiomics_getElites_elite_num1",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
                                                                                                                  ...
                                                                                                                  conditionalPanel(condition = "input.validation_radiomics_getElites_method==2",
                                                                                                                                   ...
                                                                                                                                   conditionalPanel(condition = "input.validation_radiomics_getElites_filtration2==1",column(12,numericInput("validation_radiomics_getElites_elite_num2",label="An integer cutoff of exact number for selecting top elites",value=100,min=0,step=1))),
